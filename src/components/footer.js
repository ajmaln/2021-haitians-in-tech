    ...
    <div className="footer">
        <Container fluid>
            <Row>
                <Col>
                    <div><Logo /></div>
                    <h4 className="font-weight-bold">HaitiansinTech.com</h4>
                </Col>
                <Col>
                    <h3 className="title font-weight-bold">Contact Us</h3>
                ...
                <Col>
                    <h3 className="title font-weight-bold">Connect with us</h3>
